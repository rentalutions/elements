...
export const ShoppingBag = forwardRef(function ShoppingBag(props, ref) {
  ...
  return (
    <svg {...rest} ref={ref} stroke={color} width={size} height={size}>
      <path d="M6 2L3 6V20C3 20.5304 3.21071 21.0391 3.58579 21.4142C3.96086 21.7893 4.46957 22 5 22H19C19.5304 22 20.0391 21.7893 20.4142 21.4142C20.7893 21.0391 21 20.5304 21 20V6L18 2H6Z"></path>
      <path d="M3 6H21"></path>
